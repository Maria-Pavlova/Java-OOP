...
public class ControllerImpl implements Controller {
    ...
    public String startRace(String raceName) {
        ...
        List<Driver> participants = driverRepository.getAll()
                .stream()
        ...
        output.append(String.format(DRIVER_FIRST_POSITION, participants.get(0).getName(), raceName)).append(System.lineSeparator())
                .append(String.format(DRIVER_SECOND_POSITION, participants.get(1).getName(), raceName)).append(System.lineSeparator())
    ...
    public String createRace(String name, int laps) {
        Race raceToAdd = raceRepository.getByName(name);
        if (raceToAdd != null) {
